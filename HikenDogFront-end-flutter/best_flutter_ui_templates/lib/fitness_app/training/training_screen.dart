...
import '../ui_view/shan_grid_22_view.dart';
...
class _TrainingScreenState extends State<TrainingScreen>
  ...
  void addAllListData() {
    ...
    listViews.add(
      ShanItemView(
        mainText: "The limited time race",
        subText: "is currently being registered",
        imageBackground: "",
    ...
    listViews.add(HotelListView(
      callback: () {},
      hotelData: hotelList[0],
      animation: Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
          parent: widget.animationController!,
