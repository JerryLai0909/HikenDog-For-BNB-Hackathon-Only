...
// contract ShanNFT is BucketApp, ObjectApp, GroupApp {
//     /*----------------- constants -----------------*/
//     // error code
...
//         require(
//             bytes(name).length > 0,
//             string.concat("EbookShop: ", ERROR_INVALID_NAME)
//         );
//         require(
//             seriesId[name] == 0,
//             string.concat("EbookShop: ", ERROR_RESOURCE_EXISTED)
//         );
...
//         );
//         require(
//             ebookGroup[_ebookId] != 0,
//             string.concat("EbookShop: ", ERROR_GROUP_NOT_EXISTED)
//         );
...
//             string.concat("EbookShop: ", ERROR_EBOOK_NOT_ONSHELF)
//         );

//         uint256 price = ebookPrice[_ebookId];
//         require(
//             msg.value >= price,
//             string.concat("EbookShop: ", ERROR_NOT_ENOUGH_VALUE)
//         );
