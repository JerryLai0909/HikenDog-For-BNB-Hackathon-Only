    ...
    <div className={`relative ${data.showCursor && "cursor-none"}`}>
      ...
      <div className="container mx-auto mb-10">
        ...
        <div className="mt-5 laptop:mt-30 p-2 laptop:p-0" ref={workRef}>
          {/* <h1 className="text-2xl text-bold">DEMO</h1> */}

          <div className="mt-5 laptop:mt-10 grid grid-cols-1 tablet:grid-cols-5 gap-2">
        ...
        <div className="mt-10 laptop:mt-30 p-2 laptop:p-0">
          <h1 className="tablet:m-10 text-2xl text-bold">NFT types</h1>
